...
class PendaftaranController extends Controller{
    ...
    public function store1(Request $request) {
        ...
        $rules = [
            ...
            'Provinsi' => 'required',
            'Negara' => 'required',
            'notelp-hp' => 'required|min:10|max:15',
    ...
    public function store4(Request $request) {
        ...
        Pendaftaran::create([
            ...
            'berat-tinggibadan' => $form->data['step1']['berat-tinggibadan'] ?? null,
            ...
            'RT-RW' => $form->data['step1']['RT-RW'] ?? null,
            'd-kelurahan' => $form->data['step1']['d-kelurahan'] ?? null,
            ...
            'rt-rwortu' => $form->data['step3']['rt-rwortu'] ?? null,
            'Kodepos-ortu' => $form->data['step3']['Kodepos-ortu'] ?? null,
            'd-kelurahanortu' => $form->data['step3']['d-kelurahanortu'] ?? null,
            'Kecamatan-ortu' => $form->data['step3']['Kecamatan-ortu'] ?? null,
