<x-sidebar>
    ...
    <div class="container mt-3">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            <h2 class="text-maroon fw-bold mb-3 judul">Data Admin</h2>
        ...
        <div class="col-md-15 mb-2 d-flex justify-content-md-end">
            <button class="btn btnadd" data-bs-toggle="modal" data-bs-target="#addAdminModal">Add New</button>
        </div>
